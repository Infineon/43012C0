 ...
 *
 * Wiced Transport in RAW UART mode uses a single circular buffer to receive the data
 * Application should specify the size of this receive buffer when doing transport init
 */
